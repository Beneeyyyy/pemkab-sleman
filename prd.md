...
Project Name: Sleman Digital Command Center (GDCC) - MVP Phase

1. Executive Summary
   Platform berbasis web untuk memantau percakapan publik terkait PemKab Sleman di media sosial utama dan menyediakan asisten cerdas berbasis AI untuk pembuatan konten strategis. Tujuan utamanya adalah memberikan situational awareness (kesadaran situasi) kepada tim media PemKab.
2. Problem Statement
   • Blind Spot: Tim media PemKab sulit melacak sentimen negatif secara manual di tengah jutaan komentar.
...
3. Target User
   • Admin/Operator: Tim Media PemKab Sleman (Pusat/Daerah).
   • Decision Maker: Petinggi PemKab (melihat ringkasan eksekutif).
4. Fitur Utama (Scope MVP)
   ...
   • Keyword Tracking: Input kata kunci (misal: "Sleman", "Airlangga", "Isu X").
   ...
   • Top Issues: Menampilkan 5 topik/hashtag yang paling sering muncul bersamaan dengan keyword PemKab.
   ...
   • Trend Insight (Simplified): Menampilkan daftar topik yang sedang trending di Twitter (via API) sebagai referensi ide.
...
7. Ingest: Scheduler (Cron Job Laravel) berjalan tiap 30 menit → Panggil API Scraper (Apify) untuk keyword "Sleman".
...
1. Visual Identity (Style Guide)
   Karena ini untuk PemKab Sleman, kita mainkan psikologi warna identitas mereka namun dengan sentuhan teknologi modern.
   ...
   o Primary Accent (Sleman): Sleman Yellow (#FFE000 atau #FCCF00). Gunakan untuk tombol utama, angka penting, dan highlight aktif.
   o Sentiment Colors:
...
2. User Flow (Alur Kerja Pengguna)
   ...
   Scenario: Muncul isu negatif tentang "Kader Sleman di daerah X".
1. Detection (Monitoring): Sistem menangkap lonjakan sentimen negatif > 20% pada keyword "Sleman Daerah X".
...
3. Mockup Description (Halaman Kunci)
   ...
   • Header: Logo Sleman & Nama App (misal: "G-Radar"). Ada ticker text berjalan berisi Trending Topic terkini.
...
1. Viral Probability: Prediksi AI (misal: "High - Isu Panas").
   ...
   • Peta Indonesia (Bawah): Heatmap. Warna kuning pekat di provinsi yang sedang banyak membicarakan Sleman.
...
Hook (0-3 detik): (Visual: Petani sedang sedih) "Siapa bilang suara petani gak didengar? Sleman turun tangan!"
Isi (3-15 detik): (Visual: Kader Sleman memberikan bantuan) "Langsung gercep, hari ini distribusi pupuk subsidi diamankan..."
CTA (Call to Action): "Komen di bawah daerah mana lagi yang butuh bantuan!"
o Hashtag Generator: #SlemanPeduli #PetaniSejahtera #JatimBangkit (AI memilih hashtag yang relevan dan viral).
